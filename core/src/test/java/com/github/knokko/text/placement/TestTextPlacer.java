...
public class TestTextPlacer {
	...
	public void testAggressiveCursorXRegression() {
		...
		requests.add(new TextPlaceRequest(
				testCase, -4, -2, width - 1, height - 1,
				18, 15, 1, TextAlignment.DEFAULT, null
		));
	...
	public void testWrongFontRegressionItalic() {
		...
		requests.add(new TextPlaceRequest(
				oldItalicText, 0, 5, 5000, 45,
				20, 20, 1, TextAlignment.DEFAULT, null
		));
	...
	public void testRegressionParallel() {
		...
		for (String line : UnicodeLines.get()) {
			requests.add(new TextPlaceRequest(
					line, 10, 10, 5000, 90,
					60, 40, 1, TextAlignment.DEFAULT, null
			));
		}

		for (int counter = 0; counter < 10; counter++) {
			var result = placer.place(requests, 3).size();
			assertEquals(18263, result);
		}
	...
	public void testAscentRegression() {
		...
		List<TextPlaceRequest> requests = new ArrayList<>();
		requests.add(new TextPlaceRequest(
				testString, 10, 110, 1000, 1900,
				160, 30, 1, TextAlignment.DEFAULT, null
		));
	...
	public void regressionHiInsideArabic() {
		...
		requests.add(new TextPlaceRequest(
				...
				10, 50, 490, 80, 60, 15, 1, TextAlignment.DEFAULT, null
		));
	...
	public void testOffsetRegressionGujarati() {
		...
		List<TextPlaceRequest> requests = new ArrayList<>();
		requests.add(new TextPlaceRequest(
				gujaratiText, 10, 10, 500, 40,
				20, 15, 1, TextAlignment.DEFAULT, null
		));
